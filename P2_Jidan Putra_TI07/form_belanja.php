    ...
    <div class="col-8">
        ...
        <form>
            <div class="form-group row">
                <label for="cutomer" class="col-4 col-form-label">Customer</label> 
                <div class="col-8">
                <input id="cutomer" name="cutomer" placeholder="Masukan Nama Customer" type="text" class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
