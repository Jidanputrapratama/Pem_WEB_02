            ...
            <div class="container px-5 my-5">
                <form id="contactForm" action="proses_pesanan.php" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="tanggal" id="tanggal" type="date" value="<?= $pesanan['tanggal'] ?>" data-sb-validations="required" />
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="total_harga" id="total_harga" type="text" value="<?= $pesanan['total_harga'] ?>" data-sb-validations="required" />
                        <div class="invalid-feedback" data-sb-feedback="total_harga:required">Total Harga is
                            required.</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="qty">QTY</label>
                        <input class="form-control" name="qty" id="qty" type="text" value="<?= $pesanan['qty'] ?>" data-sb-validations="required" />
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="nama_pemesan" id="namaKotaHotel" type="text" value="<?= $pesanan['nama_pemesan'] ?>" data-sb-validations="required" />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_pemesan" class="form-control" id="" cols="5" rows="10"><?= $pesanan['alamat_pemesan'] ?></textarea>
