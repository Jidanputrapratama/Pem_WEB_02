            ...
            <div class="container px-5 my-5">
                <form id="contactForm" action="proses_pesanan.php" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="tanggal" id="tanggal" type="date" placeholder="tanggal" data-sb-validations="required" />
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="total_harga" id="total_harga" type="text" placeholder="total_harga " data-sb-validations="required" />
                        <div class="invalid-feedback" data-sb-feedback="total_harga:required">total_harga is
                            required.</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="qty">QTY</label>
                        <input class="form-control" name="qty" id="qty" type="text" placeholder="qty" data-sb-validations="required" />
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="nama_pemesan" id="namaKotaHotel" type="text" placeholder="Nama Anda" data-sb-validations="required" />
